...
const App = () => {
    ...
    const [isMinFieldError, setIsMinFieldError] = useState(false);
    ...
    const handleSubmit = (event) => {
        ...
        const isAtLeastOneFieldFilled = Object.values(dataObj).some(
            (value) => value.trim() !== ""
        );

        if (!isAtLeastOneFieldFilled) {
            setIsMinFieldError(true);
            event.stopPropagation();
            return;
        } else {
            setIsMinFieldError(false);
        }
    ...
    return (
        <div className='page-background'>
            ...
            />
            <Container className='d-flex flex-column justify-content-center align-items-center form-text mobile-padding form-container'>
                <h3
